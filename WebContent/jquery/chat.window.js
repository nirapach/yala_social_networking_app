/**
 *
Source: got this from Semika Siriwardana http://skillshared.blogspot.com/2012/10/facebook-similar-chat-for-your-java-web.html
...
function ChatWindow(config) {
    ...
    this.getWindowFooter = function() {
    	...
    	footerDIV.style.backgroundColor = '#0066FF'; 
    ...
    this.getWindowHeader = function() {
    	...
    	headerDIV.style.backgroundColor = '#0066FF'; 
    ...
    this.getWindowHTML = function() {
    	...
    	windowDIV.style.border   = '1px solid #0066FF'; 
